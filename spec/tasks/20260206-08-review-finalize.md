...
- [x] Create `src/cli/commands/review/finalize.ts` with interface and stub
- [x] Verify test fails (Red)
- [x] Implement `executeReviewFinalize`
- [x] Verify test passes (Green)
- [x] Run `npm run lint && npm run typecheck`
- [x] Acceptance: Correct articles get finalized based on status
...
- [x] Add `dryRun` option to `ReviewFinalizeOptions`
- [x] Implement dry-run logic (compute but don't write)
- [x] Verify test passes (Green)
- [x] Run `npm run lint && npm run typecheck`
- [x] Acceptance: `--dry-run` previews without modifying data
...
- [x] Add `minReviewers` option (default: 1)
- [x] Implement minimum reviewer check
- [x] Verify test passes (Green)
- [x] Run `npm run lint && npm run typecheck`
- [x] Acceptance: `--min-reviewers` correctly gates finalization
...
- [x] Implement `formatFinalizeOutput`
- [x] Register `review finalize` subcommand in `src/cli/index.ts`
  - Options: `--session <id>` (required), `--dry-run`, `--min-reviewers <n>`
- [x] Verify test passes (Green)
- [x] Run `npm run lint && npm run typecheck`
- [x] Acceptance: CLI command works and output matches spec
...
- [x] Acceptance: All tests pass, finalize works in real workflows
