...
- [ ] Acceptance: Writes go to the correct config file based on scope flag
...
- [ ] Refactor if needed
- [ ] Verify test still passes
- [ ] Acceptance: Secret keys to local config produce a warning
...
- [ ] Refactor if needed
- [ ] Verify test still passes
- [ ] Acceptance: `--show-origin` correctly identifies the source of each config value
...
- [ ] Refactor if needed
- [ ] Verify test still passes
- [ ] Acceptance: Filtered listing works for each scope
...
- [ ] Refactor if needed
- [ ] Verify test still passes
- [ ] Acceptance: `--env-vars` prints all available environment variable mappings
...
- [ ] Refactor if needed
- [ ] Verify test still passes
- [ ] Acceptance: `search-hub config --help` shows all new options
...
- [ ] **Manual verification**: Test all flag combinations in a real terminal
