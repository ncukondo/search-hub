...
- [x] Implement: `acquire()` を `lookupTerm` から `fetchLookup` の各呼び出し前に移動
- [x] Verify test passes (Green)
- [x] Run `npm run lint && npm run typecheck`
- [x] Refactor if needed
- [x] Verify test still passes
- [x] Acceptance: HTTP リクエスト単位で rate limit が正しく適用される
...
- [x] Write test: `src/query/vocab-cache.test.ts`
...
- [x] Verify test fails (Red)
- [x] Create `src/query/vocab-cache.ts`
  ```typescript
...
- [x] Refactor if needed
- [x] Verify test still passes
- [x] Acceptance: キャッシュの読み書きが正しく動作する
...
- [x] Verify test fails (Red)
- [x] Implement: `MeSHLookupClient` のコンストラクタに `cache?: VocabCache` を追加
- [x] Verify test passes (Green)
- [x] Run `npm run lint && npm run typecheck`
- [x] Refactor if needed
- [x] Verify test still passes
- [x] Acceptance: キャッシュヒット時は API 呼び出しゼロ
...
- [x] Refactor if needed
- [x] Verify test still passes
- [x] Acceptance: 統制語を含むクエリで validate 時に自動的に vocab チェックが走る
...
- [x] Verify test fails (Red)
- [x] Implement: vocab validation のエラーハンドリングを調整
- [x] Verify test passes (Green)
- [x] Run `npm run lint && npm run typecheck`
- [x] Refactor if needed
- [x] Verify test still passes
- [x] Acceptance: オフライン環境でも `query validate` が正常終了する
...
- [x] Verify test fails (Red)
- [x] Implement: CLI コマンド定義を更新
- [x] Verify test passes (Green)
- [x] Run `npm run lint && npm run typecheck`
- [x] Refactor if needed
- [x] Verify test still passes
- [x] Acceptance: CLI から全機能が正しく動作する
