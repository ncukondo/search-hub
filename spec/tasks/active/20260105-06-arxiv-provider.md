...
- [x] Acceptance: Types match spec/providers/arxiv.md
...
- [x] Create stub: `src/providers/arxiv/translator.ts`
...
- [x] Run `npm run lint && npm run typecheck`
- [x] Acceptance: Translator produces valid arXiv queries per spec

### Step 3: Implement Atom XML Response Parser

- [x] Write test: `src/providers/arxiv/parser.test.ts`
...
- [x] Create stub: `src/providers/arxiv/parser.ts`
- [x] Verify tests fail (Red)
- [x] Implement:
...
- [x] Write test: `src/providers/arxiv/client.test.ts`
...
- [x] Create stub: `src/providers/arxiv/client.ts`
- [x] Verify tests fail (Red)
- [x] Implement:
  - `ArxivClient` class
...
- [x] Verify tests pass (Green)
- [x] Run `npm run lint && npm run typecheck`
- [x] Acceptance: Client correctly calls arXiv API with rate limiting

### Step 5: Implement arXiv Provider

- [x] Write test: `src/providers/arxiv/provider.test.ts`
...
- [x] Create stub: `src/providers/arxiv/provider.ts`
- [x] Verify tests fail (Red)
- [x] Implement:
...
- [x] Write test: `src/providers/arxiv/provider.test.ts` (additional tests)
...
- [x] Verify tests pass (Green)
- [x] Run `npm run lint && npm run typecheck`
- [x] Acceptance: Can interrupt and resume arXiv searches

### Step 6: Implement E2E Tests

- [x] Update test: `src/providers/arxiv/arxiv.e2e.test.ts`
...
- [x] Write test: `src/providers/arxiv/index.test.ts`
  - Test exports are correct
  - Test provider can be created from registry
- [x] Create `src/providers/arxiv/index.ts`
